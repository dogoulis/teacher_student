...
--teacher_weights ./checkpoints/thsa/teacher/resnet50/best-ckpt.pt --name resnet50 --project $PROJECT_NAME_2 --group student_on_animals --volume_loss yes
...
--teacher_weights ./checkpoints/tash/teacher/resnet50/best-ckpt.pt --name resnet50 --project $PROJECT_NAME_2 --group student_on_humans --volume_loss yes
