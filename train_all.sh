...
--teacher_weights ./checkpoints/thsa/teacher/resnet50/best-ckpt.pt --name resnet50 --project $PROJECT_NAME_2 --group student_on_animals_volume --volume_loss yes
...
--teacher_weights ./checkpoints/thsa/teacher/swin-tiny/best-ckpt.pt --name swin-tiny --project $PROJECT_NAME_2 --group student_on_animals_volume --volume_loss yes
...
--teacher_weights ./checkpoints/thsa/teacher/vit-small/best-ckpt.pt --name vit-small --project $PROJECT_NAME_2 --group student_on_animals_volume --volume_loss yes
...
--teacher_weights ./checkpoints/tash/teacher/resnet50/best-ckpt.pt --name resnet50 --project $PROJECT_NAME_2 --group student_on_humans_volume --volume_loss yes
...
--teacher_weights ./checkpoints/tash/teacher/swin-tiny/best-ckpt.pt --name swin-tiny --project $PROJECT_NAME_2 --group student_on_humans_volume --volume_loss yes
...
--teacher_weights ./checkpoints/tash/teacher/vit-small/best-ckpt.pt --name vit-small --project $PROJECT_NAME_2 --group student_on_humans_volume --volume_loss yes